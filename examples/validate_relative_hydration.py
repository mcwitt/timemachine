...
from fe import model_abfe, model_relative_hydration
...
if __name__ == "__main__":
    ...
    model_relative = model_relative_hydration.RelativeHydrationModel(
        client,
        forcefield,
        solvent_system,
        solvent_coords,
    ...
    # assert 0
    model_absolute = model_abfe.AbsoluteModel(
        client,
        forcefield,
        solvent_system,
        solvent_coords,
