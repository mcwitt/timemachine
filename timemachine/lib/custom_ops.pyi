...
class Context:
    ...
    def local_md(self, lambda_schedule: numpy.typing.NDArray[numpy.float64], iterations: int, global_steps: int, local_steps: int, store_x_interval: int, local_idxs: numpy.typing.NDArray[numpy.uint32], local_bps: List[BoundPotential], cutoff: float = ...) -> tuple: ...
    ...
    def set_v_t(self, arg0: numpy.typing.NDArray[numpy.float64]) -> None: ...
