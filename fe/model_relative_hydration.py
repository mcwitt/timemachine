...
class RelativeHydrationModel():
    ...
    def predict(self, ff_params: list, mol_a: Chem.Mol, mol_b: Chem.Mol, prefix: str):
        ...
        minimized_host_coords = minimized_coords[:num_host_atoms]
        ...
        combined_coords = np.concatenate([minimized_host_coords, mol_a_coords, mol_b_coords])
        ...
        combined_coords = np.concatenate([minimized_host_coords, mol_b_coords, mol_a_coords])
